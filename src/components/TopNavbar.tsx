  ...
  const groups: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Yelo Ingredients', onClick: () => { setSelectedIngerinesBrand('yelo'); setCurrentView('ingerines'); }, isActive: currentView === 'ingerines' && selectedIngerinesBrand === 'yelo', viewId: 'ing-yelo' },
...
const ALL_NAV_ITEMS = [
  ...
  { id: 'ing-yelo', label: 'Yelo Ingredients', view: 'ingerines', subBrand: 'yelo', action: (sV: any, sB: any, sA: any, sI: any) => { sI('yelo'); sV('ingerines'); } },
